...
val LightColors = lightColorScheme(
    ...
    secondaryContainer = MossWash,
    onSecondaryContainer = Color(0xFF1A2A22),
    ...
    errorContainer = Color(0xFFF5D4CE),
    onErrorContainer = Color(0xFF3E0F0A),
...
val DarkColors = darkColorScheme(
    ...
    error = Color(0xFFE8A399),
    onError = Color(0xFF3E0F0A),
    errorContainer = Color(0xFF6F2A20),
    onErrorContainer = Color(0xFFF5D4CE),
    outline = OutlineDark,
